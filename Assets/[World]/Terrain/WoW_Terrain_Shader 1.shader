Shader "Machinima/WoWTerrain1"
{
    ...
    void surf (Input IN, inout SurfaceOutputStandard o)
    {
      ...
      fixed4 mainOutput = mainCol.rgba * (1.0 - tex1Amount.r) ;
      fixed4 blendOutput1 = tex1Col.rgba * tex1Amount.r;
	  fixed4 mainOutput1 = (mainOutput + blendOutput1) * (1.0 - tex1Amount.g);
      fixed4 blendOutput2 = tex2Col.rgba * tex1Amount.g;
	  fixed4 mainOutput2 = (mainOutput1 + blendOutput2) * (1.0 - tex1Amount.b);
	  fixed4 blendOutput3 = tex3Col.rgba * tex1Amount.b;
